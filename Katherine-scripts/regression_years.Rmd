...
```{r}
set.seed(86)
lm_potato <- lm(yields_average ~ Experiment+claderich0.1+ cladediv0.1+ claderich0.2+cladediv0.35+ cladediv0.7+ cladediv0.8+claderich0.45, data=train_regre)
summary(lm_potato)
```
...
par(mfrow=c(2,2), mar=c(3,3,1,2), mgp=c(1.8,.5,0))
# residual plot
plot(lm_potato, which=1, pch=21, bg="dimgray", cex=1.2, lwd=2)
# qqplot
qqnorm(stdresid, main="Normal QQ Plot of Residuals")
abline(0, 1, col="red", lwd=3)
# leverage value
plot(pii, pch=21, bg="dimgray", cex=1.2, main="Leverage Value")
# cooks distance
plot(cooki, pch=21, bg="dimgray", cex=1.2, main="Cook's Distance")
```
...
```{r}
set.seed(86)
selected_features = c("Experiment", "cladediv0.1","claderich0.1","claderich0.2","cladediv0.35", "cladediv0.7", "cladediv0.8","claderich0.45")
